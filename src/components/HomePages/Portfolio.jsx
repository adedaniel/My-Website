    ...
    <>
      <div className="pt-1 bgColor">
        <div className="text-center py-5" id="made">
          <h1 className="mb-1 bgGrey mt20">Portfolio</h1>
                ...
                <div className="container my-5">
                  <div className="row text-left portfolioWrapper py5 pl5 bgPrimaryGrey">
                    <div className="col-md-4 caption">
                      <h1 className='h1 inverseNeutral'>{project.node.frontmatter.title}</h1>
                      <p className='greyText float-left'>{project.node.frontmatter.category}</p>
                      <div className="verticalLine">
                      </div>
                      <p className='greyText float-left'>{project.node.frontmatter.date}</p>
                      <h5 className="hoverEffect position-absolute mt-4">Details</h5>
                    </div>
          ...
          <div className="container text-left extra  mt-5">
            <h5 className='text-left inverseNeutral'>I have also worked on a bitcoin rate converter,
            an online event ticketing system, school and property management platforms, a roboadvisor
            for a popular investment company, a modern payment gateway application, an election
            prediction system among many others I may not be able to showcase here cos, yunno, they're
             not live yet. <br /><br />
            Nevertheless, I'm very willing to tell you anything you need to know about them if you're interested. Just reach out!
            </h5>
          </div>
        </div>
      </div>
...
.image1{
    ...
    margin-left: 110px;
      ...
      .portfolioWrapper:hover{
        box-shadow: -5px 8px 15px rgba(0,0,0,0.1), 0 47px 50px rgba(0,0,0,0.03);
      }
      .gwd-p-1miv {
        height: auto;
        left: 0px;
